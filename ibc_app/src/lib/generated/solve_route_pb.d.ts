 ...
 */
export declare const file_solve_route: GenFile;
 ...
 *
 * @generated from message rpc.v1.SolveRouteRequest
 */
export declare type SolveRouteRequest = Message<"rpc.v1.SolveRouteRequest"> & {
  /**
 ...
 */
export declare const SolveRouteRequestSchema: GenMessage<SolveRouteRequest>;

/**
 * @generated from message rpc.v1.SolveRouteResponse
 */
export declare type SolveRouteResponse = Message<"rpc.v1.SolveRouteResponse"> & {
  /**
  ...
  /**
   * @generated from oneof rpc.v1.SolveRouteResponse.route
   */
  route: {
    /**
 ...
 */
export declare const SolveRouteResponseSchema: GenMessage<SolveRouteResponse>;
...
/**
 * @generated from message rpc.v1.SolverSupportedChainsResponse
 */
export declare type SolverSupportedChainsResponse = Message<"rpc.v1.SolverSupportedChainsResponse"> & {
  /**
 ...
 */
export declare const SolverSupportedChainsResponseSchema: GenMessage<SolverSupportedChainsResponse>;
...
export declare const SolverService: GenService<{
   ...
   * Use this to discover what denom a token has on different chains
   *
   * @generated from rpc rpc.v1.SolverService.GetTokenDenoms
   */
  getTokenDenoms: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc rpc.v1.SolverService.GetChainInfo
   */
  getChainInfo: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc rpc.v1.SolverService.GetSolverSupportedChains
   */
  getSolverSupportedChains: {
    methodKind: "unary";
    input: typeof EmptySchema;
    output: typeof SolverSupportedChainsResponseSchema;
  },
  /**
   ...
   *
   * @generated from rpc rpc.v1.SolverService.GetChainTokens
   */
  getChainTokens: {
    methodKind: "unary";
