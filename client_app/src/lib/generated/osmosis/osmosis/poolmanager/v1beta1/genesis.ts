  ...
  fromJSON(object: any): Params {
    return {
      poolCreationFee: globalThis.Array.isArray(object?.poolCreationFee)
        ...
        : globalThis.Array.isArray(object?.pool_creation_fee)
        ? object.pool_creation_fee.map((e: any) => Coin.fromJSON(e))
        : [],
      takerFeeParams: isSet(object.takerFeeParams)
        ? TakerFeeParams.fromJSON(object.takerFeeParams)
        : isSet(object.taker_fee_params)
        ? TakerFeeParams.fromJSON(object.taker_fee_params)
        : undefined,
      authorizedQuoteDenoms: globalThis.Array.isArray(object?.authorizedQuoteDenoms)
        ...
        : globalThis.Array.isArray(object?.authorized_quote_denoms)
        ? object.authorized_quote_denoms.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      nextPoolId: isSet(object.nextPoolId)
        ? globalThis.Number(object.nextPoolId)
        : isSet(object.next_pool_id)
        ? globalThis.Number(object.next_pool_id)
        : 0,
      params: isSet(object.params) ? Params.fromJSON(object.params) : undefined,
      poolRoutes: globalThis.Array.isArray(object?.poolRoutes)
        ? object.poolRoutes.map((e: any) => ModuleRoute.fromJSON(e))
        : globalThis.Array.isArray(object?.pool_routes)
        ? object.pool_routes.map((e: any) => ModuleRoute.fromJSON(e))
        : [],
      takerFeesTracker: isSet(object.takerFeesTracker)
        ? TakerFeesTracker.fromJSON(object.takerFeesTracker)
        : isSet(object.taker_fees_tracker)
        ? TakerFeesTracker.fromJSON(object.taker_fees_tracker)
        : undefined,
      poolVolumes: globalThis.Array.isArray(object?.poolVolumes)
        ? object.poolVolumes.map((e: any) => PoolVolume.fromJSON(e))
        : globalThis.Array.isArray(object?.pool_volumes)
        ? object.pool_volumes.map((e: any) => PoolVolume.fromJSON(e))
        : [],
      denomPairTakerFeeStore: globalThis.Array.isArray(object?.denomPairTakerFeeStore)
        ...
        : globalThis.Array.isArray(object?.denom_pair_taker_fee_store)
        ? object.denom_pair_taker_fee_store.map((e: any) => DenomPairTakerFee.fromJSON(e))
        : [],
    };
  },
...
export const TakerFeeParams: MessageFns<TakerFeeParams> = {
  ...
  fromJSON(object: any): TakerFeeParams {
    return {
      defaultTakerFee: isSet(object.defaultTakerFee)
        ? globalThis.String(object.defaultTakerFee)
        : isSet(object.default_taker_fee)
        ? globalThis.String(object.default_taker_fee)
        : "",
      osmoTakerFeeDistribution: isSet(object.osmoTakerFeeDistribution)
        ...
        : isSet(object.osmo_taker_fee_distribution)
        ? TakerFeeDistributionPercentage.fromJSON(object.osmo_taker_fee_distribution)
        : undefined,
      nonOsmoTakerFeeDistribution: isSet(object.nonOsmoTakerFeeDistribution)
        ...
        : isSet(object.non_osmo_taker_fee_distribution)
        ? TakerFeeDistributionPercentage.fromJSON(object.non_osmo_taker_fee_distribution)
        : undefined,
      adminAddresses: globalThis.Array.isArray(object?.adminAddresses)
        ? object.adminAddresses.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.admin_addresses)
        ? object.admin_addresses.map((e: any) => globalThis.String(e))
        : [],
      communityPoolDenomToSwapNonWhitelistedAssetsTo: isSet(object.communityPoolDenomToSwapNonWhitelistedAssetsTo)
        ...
        : isSet(object.community_pool_denom_to_swap_non_whitelisted_assets_to)
        ? globalThis.String(object.community_pool_denom_to_swap_non_whitelisted_assets_to)
        : "",
      reducedFeeWhitelist: globalThis.Array.isArray(object?.reducedFeeWhitelist)
        ...
        : globalThis.Array.isArray(object?.reduced_fee_whitelist)
        ? object.reduced_fee_whitelist.map((e: any) => globalThis.String(e))
        : [],
      communityPoolDenomWhitelist: globalThis.Array.isArray(object?.communityPoolDenomWhitelist)
        ...
        : globalThis.Array.isArray(object?.community_pool_denom_whitelist)
        ? object.community_pool_denom_whitelist.map((e: any) => globalThis.String(e))
        : [],
      dailyStakingRewardsSmoothingFactor: isSet(object.dailyStakingRewardsSmoothingFactor)
        ...
        : isSet(object.daily_staking_rewards_smoothing_factor)
        ? globalThis.Number(object.daily_staking_rewards_smoothing_factor)
        : 0,
    };
  },
  ...
  fromJSON(object: any): TakerFeeDistributionPercentage {
    return {
      stakingRewards: isSet(object.stakingRewards)
        ? globalThis.String(object.stakingRewards)
        : isSet(object.staking_rewards)
        ? globalThis.String(object.staking_rewards)
        : "",
      communityPool: isSet(object.communityPool)
        ? globalThis.String(object.communityPool)
        : isSet(object.community_pool)
        ? globalThis.String(object.community_pool)
        : "",
  ...
  fromJSON(object: any): TakerFeesTracker {
    return {
      takerFeesToStakers: globalThis.Array.isArray(object?.takerFeesToStakers)
        ...
        : globalThis.Array.isArray(object?.taker_fees_to_stakers)
        ? object.taker_fees_to_stakers.map((e: any) => Coin.fromJSON(e))
        : [],
      takerFeesToCommunityPool: globalThis.Array.isArray(object?.takerFeesToCommunityPool)
        ...
        : globalThis.Array.isArray(object?.taker_fees_to_community_pool)
        ? object.taker_fees_to_community_pool.map((e: any) => Coin.fromJSON(e))
        : [],
      heightAccountingStartsFrom: isSet(object.heightAccountingStartsFrom)
        ? globalThis.Number(object.heightAccountingStartsFrom)
        : isSet(object.height_accounting_starts_from)
        ? globalThis.Number(object.height_accounting_starts_from)
        : 0,
      takerFeesToBurn: globalThis.Array.isArray(object?.takerFeesToBurn)
        ? object.takerFeesToBurn.map((e: any) => Coin.fromJSON(e))
        : globalThis.Array.isArray(object?.taker_fees_to_burn)
        ? object.taker_fees_to_burn.map((e: any) => Coin.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): PoolVolume {
    return {
      ...
      poolVolume: globalThis.Array.isArray(object?.poolVolume)
        ...
        : globalThis.Array.isArray(object?.pool_volume)
        ? object.pool_volume.map((e: any) => Coin.fromJSON(e))
        : [],
    };
  },
