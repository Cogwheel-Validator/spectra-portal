...
export const EthAccount: MessageFns<EthAccount> = {
  encode(message: EthAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<EthAccount>, I>>(base?: I): EthAccount {
    return EthAccount.fromPartial(base ?? ({} as any));
  },
