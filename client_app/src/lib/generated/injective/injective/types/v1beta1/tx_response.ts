...
export const TxResponseGenericMessage: MessageFns<TxResponseGenericMessage> = {
  encode(message: TxResponseGenericMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.header !== "") {
  ...
  create<I extends Exact<DeepPartial<TxResponseGenericMessage>, I>>(base?: I): TxResponseGenericMessage {
    return TxResponseGenericMessage.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TxResponseGenericMessage>, I>>(object: I): TxResponseGenericMessage {
    const message = createBaseTxResponseGenericMessage();
...
export const TxResponseData: MessageFns<TxResponseData> = {
  encode(message: TxResponseData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.messages) {
      TxResponseGenericMessage.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<TxResponseData>, I>>(base?: I): TxResponseData {
    return TxResponseData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TxResponseData>, I>>(object: I): TxResponseData {
    const message = createBaseTxResponseData();
